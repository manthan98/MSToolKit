...
public extension UIView {
    ...
    public func centerInSuperview(size: CGSize = .zero) {
        ...
        let superViewToCenterXWith: NSLayoutXAxisAnchor? = superview?.safeAreaLayoutGuide.centerXAnchor
        
        if let superviewCenterXAnchor = superViewToCenterXWith {
            centerXAnchor.constraint(equalTo: superviewCenterXAnchor).isActive = true
        }
        
        let superViewToCenterYWith: NSLayoutYAxisAnchor?  = superview?.safeAreaLayoutGuide.centerYAnchor
        
        if let superviewCenterYAnchor = superViewToCenterYWith {
